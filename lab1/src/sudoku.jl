...
@constraint(SUDO, row[i in 1:9, k in 1:9], sum(x[i, j, k] for j in 1:9) == 1)

#-------------------------------------------------------------------------------

@constraint(SUDO, col[j in 1:9, k in 1:9], sum(x[i, j, k] for i in 1:9) == 1)
#-------------------------------------------------------------------------------

@constraint(SUDO, within_cell[i in 1:9, j in 1:9], 
    sum(x[i, j, k] for k in 1:9) == 1)

#-------------------------------------------------------------------------------

@constraint(SUDO, box[i in 1:3:7, j in 1:3:7, k in 1:9], 
    sum(x[i + within_x, j + within_y, k] for within_x in 0:2, within_y in 0:2) == 1)
